...
<body>
        ...
        <div class="topber__profile">
            <?php
                ...
                if ( $data = mysqli_fetch_assoc( $result ) ) {
                    ...
                    $avatar = $data['avatar'];
                ?>
                <img src="assets/img/<?php echo "$avatar"; ?>" height="60" width="60" class="square" alt="profile">
                <div class="dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                        ...
                        <a class="dropdown-item" href="index.php?id=userProfile">About</a>
    ...
    <section id="sideber" class="sideber">
        <ul class="sideber__ber">
            <h3 class="sideber__panel"><img src="assets/img/<?php echo "$avatar"; ?>" height="60" width="60"><br><span><br><h2>SITRC</h2><br>Nashik-MH</i> </h3>
            <li id="left" class="sideber__item<?php if ( 'dashboard' == $id ) {
                                                  echo " active";
                                              }?>">
                <a href="index.php?id=dashboard">Home</a>
            </li>
            <?php if ( 'admin' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addManager' == $id ) {
                    ...
                    <a href="index.php?id=addManager"><i id="left" class="fas fa-user-plus"></i></i>New Manager</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allManager' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allManager"><i id="left" class="fas fa-user"></i>Managers</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addPharmacist' == $id ) {
                    ...
                    <a href="index.php?id=addPharmacist"><i id="left" class="fas fa-user-plus"></i></i>New
                        Stores</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allPharmacist' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allPharmacist"><i id="left" class="fas fa-user"></i>Stores</a>
            </li>
            <?php if ( 'admin' == $sessionRole || 'manager' == $sessionRole || 'pharmacist' == $sessionRole ) {?>
                ...
                <li id="left" class="sideber__item sideber__item--modify<?php if ( 'addSalesman' == $id ) {
                    ...
                    <a href="index.php?id=addSalesman"><i id="left" class="fas fa-user-plus"></i>New Salesman</a>
                </li><?php }?>
            <li id="left" class="sideber__item<?php if ( 'allSalesman' == $id ) {
    echo " active";
}?>">
                <a href="index.php?id=allSalesman"><i id="left" class="fas fa-user"></i>Salesmans</a>
            </li>
        </ul>
        <footer class="text-center"><span>SITRC</span><br> Sandip Foundation</footer>
    </section>
    <!--------------------------------- #Sideber -------------------------------->
        ...
        <div class="container">
            ...
            <div class="manager">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            <td>
                                                <center><img class="square" width="40" height="40" src="assets/img/<?php echo $manager['avatar']; ?>" alt=""></center>
                                            </td>
                ...
                <?php if ( 'addManager' == $id ) {?>
                    <div class="addManager">
                        <div class="main__form">
                            <div class="main__form--title text-center">Add New </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col col-12">
                                        <label class="input">
                                            ...
                                            <i id="pwd" class="fas fa-info right"></i>
                                        </label>
                                    </div>
                ...
                <?php if ( 'editManager' == $action ) {
                    ...
                    <div class="addManager">
                        <div class="main__form">
                            <div class="main__form--title text-center">Update </div>
                            <form action="add.php" method="POST">
                                <div class="form-row">
                                    <div class="col col-12">
                                        <label class="input">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            <td>
                                                <center><img class="square" width="40" height="40" src="assets/img/<?php echo $pharmacist['avatar']; ?>" alt=""></center>
                                            </td>
                        ...
                        <form action="index.php">
                            ...
                            <div class="form-row text-center">
                                <div class="col col-12 text-center pb-3">
                                    <img src="assets/img/<?php echo $data['avatar']; ?>" class="img-fluid square" alt="">
                                </div>
                                <div class="col col-12">
            ...
            <?php if ( 'userProfileEdit' == $id ) {
                ...
                <div class="userProfileEdit">
                    <div class="main__form">
                        <div class="main__form--title text-center">Update About</div>
